package com.example.group.myrestaurant.services;
...
public class YelpService {
    ...
    public ArrayList<RestaurantModel> processResults(Response response) {
        ...
        try {
            ...
            for (int i = 0; i < businessesJSON.length(); i++) {
                ...
                RestaurantModel restaurant = new RestaurantModel(name, phone, website, rating,
